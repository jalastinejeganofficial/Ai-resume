    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg p-6 text-white">
        <div className="text-center">
          ...
          <div className="text-6xl font-bold mb-2">{career_intelligence.substance_score}</div>
          <div className="text-xl font-medium">
            {getScoreLabel(career_intelligence.substance_score)}
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-2xl font-bold" style={{ color: getScoreColor(career_intelligence.role_clarity) }}>
                {career_intelligence.role_clarity}%
              </div>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="h-2 rounded-full"
                style={{ width: `${career_intelligence.role_clarity}%`, backgroundColor: getScoreColor(career_intelligence.role_clarity) }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-2xl font-bold" style={{ color: getScoreColor(career_intelligence.skill_depth) }}>
                {career_intelligence.skill_depth}%
              </div>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="h-2 rounded-full"
                style={{ width: `${career_intelligence.skill_depth}%`, backgroundColor: getScoreColor(career_intelligence.skill_depth) }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-2xl font-bold" style={{ color: getScoreColor(career_intelligence.project_intelligence) }}>
                {career_intelligence.project_intelligence}%
              </div>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="h-2 rounded-full"
                style={{ width: `${career_intelligence.project_intelligence}%`, backgroundColor: getScoreColor(career_intelligence.project_intelligence) }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-2xl font-bold" style={{ color: getScoreColor(career_intelligence.achievement_signals) }}>
                {career_intelligence.achievement_signals}%
              </div>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="h-2 rounded-full"
                style={{ width: `${career_intelligence.achievement_signals}%`, backgroundColor: getScoreColor(career_intelligence.achievement_signals) }}
              ></div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="space-y-2 text-sm text-blue-800">
          {career_intelligence.substance_score >= 70 && (
            <li>✅ Your resume demonstrates strong career substance</li>
          )}
          {career_intelligence.role_clarity < 60 && (
